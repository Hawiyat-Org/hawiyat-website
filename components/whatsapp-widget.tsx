  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative">
        ...
        <div className="absolute -inset-2 rounded-full bg-green-400 animate-pulse opacity-30 blur-sm" />
        <div className="absolute -inset-4 rounded-full bg-green-300 animate-pulse opacity-20 blur-md" />
        <div className="absolute -inset-6 rounded-full bg-green-200 animate-pulse opacity-10 blur-lg" />

  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        ...
        className="bg-gradient-to-r from-black to-gray-600 dark:from-white dark:to-gray-400 text-white   dark:text-black rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300"

...
const HeroSection = () => {
  ...
  return (
    <section
      className="hero-section relative flex min-h-[100vh] w-full max-w-[100vw] flex-col overflow-hidden"
      id="hero-section"
    >
      ...
      <div className="hero-bg-gradient relative flex h-full min-h-[100vh] w-full flex-col place-content-center gap-6 p-[5%] max-xl:place-items-center max-lg:p-6 max-md:p-4 max-md:gap-8">
        ...
        <div className="flex flex-col min-h-[60vh] max-md:min-h-[50vh] place-content-center items-center max-md:gap-6">
        ...
        <div
          className="reveal-up relative mt-8 max-md:mt-4 flex w-full place-content-center place-items-center max-md:px-0"

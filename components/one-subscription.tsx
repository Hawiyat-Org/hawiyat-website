    ...
    <section className="relative flex w-full min-h-[100vh] max-md:min-h-[80vh] flex-col place-content-center place-items-center overflow-hidden">
      <div className="w-full max-lg:max-w-full place-content-center place-items-center flex flex-col max-w-[80%] gap-4 p-4">
        ...
        <div className="mt-8 relative flex max-lg:flex-col gap-5">
          {/* Cost */}
          <div className="reveal-up flex w-full max-w-[650px] max-md:max-w-full flex-col place-items-center gap-2 rounded-lg border border-outlineColor bg-white dark:bg-[#080808] dark:border-[#1f2123]  shadow-xl max-lg:w-[320px]">
            <Image
          ...
          {/* Hawiyat */}
          <div className="reveal-up flex w-full max-w-[650px] flex-col place-items-center gap-2 rounded-lg border border-outlineColor bg-white dark:bg-[#080808] dark:border-[#1f2123]  shadow-xl max-lg:w-[320px]">
            <Image

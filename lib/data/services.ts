...
export const services: Service[] = [
  ...
  },
  {
    ...
    slug: "hosting-basic",
    name: "Cloud Basic",
    shortDesc: "Managed cloud runtime for one app",
    description: "A managed cloud runtime for a single application: container, SSL, auto-deploy, monitoring. Order by contacting the team.",
    image: "/logo.svg",
    price: "1000",
    priceLabel: "DA/month",
    cta: "See plans in DZD",
    ...
    seo: {
      title: "Managed Cloud Runtime in Algeria | 1,000 DA/month",
      description: "Managed cloud runtime in Algeria for one application: container, SSL, auto-deploy, monitoring, 512MB RAM, local support. 1,000 DA/month, ordered via the team.",
      keywords: [
        "container hosting algeria",
        "managed container hosting algeria",
    ...
    details: {
      overview: "A managed cloud runtime for a single application. Your app runs in its own container with SSL, automatic Git deploys, and basic monitoring. Perfect for personal projects, portfolios, and small websites. We handle the infrastructure so you can focus on building.",
      whatYouGet: [
        "1 application in a managed container",
      ...
      technicalSpecs: [
        "Container-based runtime, isolated per app",
    ...
    seoContent: {
      whatIs:
        "Cloud Basic from Hawiyat is a managed cloud runtime in Algeria for a single application at 1,000 DA/month. Your app runs in its own managed container, isolated and ready to go live. Perfect for personal portfolios, small websites, demo projects, and single-page applications, the plan includes one containerized application, free SSL certificates for secure connections, and automatic deployments from Git. You get 512MB RAM, custom domain support, and basic monitoring with uptime tracking. Node.js, Python, and static sites are all supported, with automatic HTTPS through Let's Encrypt and weekly backups included. Everything is managed by our Algerian team, so you never touch a server or read a line of configuration. For developers in Algeria who want a production-grade cloud runtime priced in dinars, Cloud Basic delivers managed infrastructure with local support and billing in DZD.",
      whyChoose:
        "Cloud Basic from Hawiyat is a managed cloud runtime in Algeria at 1,000 DA/month, priced in dinars with no hidden fees. Your app runs in a managed container and we handle the infrastructure behind it. You get free SSL, automatic deployments from Git, and basic monitoring, everything a personal project needs to go live. Unlike big international hosts that require foreign credit cards and charge in euros or dollars, Hawiyat accepts CCP and Baridi Mob and supports you in Arabic, French, and English from the same timezone. Your app runs on the same production-tested infrastructure that powers 100+ clients, with weekly backups and automatic HTTPS included. Whether you are running a portfolio, a demo, or a small business site, you get a professional deployment, managed for you. Upgrade to Cloud VIP anytime for a managed database and priority support.",
      howItWorks:
        "Getting your app live on Cloud Basic takes three steps. First, contact the team to order the plan at 1,000 DA/month using your preferred payment method: CCP, Baridi Mob, or USD. Second, connect your Git repository: our platform builds your app into a managed container and automatically deploys Node.js, Python, or static site projects from Git with zero configuration. Third, point your custom domain and get a free SSL certificate from Let's Encrypt, so your site is live on HTTPS within minutes. Your app keeps running in its managed container with 512MB RAM, basic monitoring with uptime tracking, and weekly backups. Every deployment is automatic, push to Git and your changes go live. If you need a database, more applications, or priority support, you can upgrade to Cloud VIP at 2,000 DA/month at any time. Support is available by email in Arabic, French, and English.",
    },
    faq: [
      {
        question: "What can I run on the Cloud Basic plan?",
        answer:
          "The Basic plan runs one application personal portfolios, small websites, demo projects, and single-page applications. It supports Node.js, Python, and static sites with 512MB RAM, free SSL, and automatic Git deployments.",
      },
      {
        question: "Do I need a foreign credit card to pay for cloud runtime plans?",
        answer:
          "No. All Hawiyat cloud runtime plans are priced in Algerian dinars and can be paid with CCP, Baridi Mob, or USD. We accept local Algerian payment methods.",
      },
      {
        question: "How do deployments work on Cloud Basic?",
        answer:
  ...
  },
  {
    ...
    slug: "hosting-vip",
    name: "Cloud VIP",
    shortDesc: "Managed cloud runtime, 2 apps + database",
    description: "A managed cloud runtime for up to two applications with a managed database and priority support. Order by contacting the team.",
    image: "/logo.svg",
    price: "2000",
    priceLabel: "DA/month",
    cta: "See plans in DZD",
    ...
    seo: {
      title: "Managed Cloud Runtime with Database in Algeria | 2,000 DA/month",
      description: "Managed cloud runtime in Algeria for two applications with a managed database, free SSL, priority support. 2,000 DA/month, ordered via the team.",
      keywords: [
        "premium container hosting algeria",
        "container hosting algeria",
        "vip hosting algeria",
    ...
    details: {
      overview: "A managed cloud runtime for up to two applications with a managed database included. Each app runs in its own managed container. Perfect for full-stack apps, SaaS projects, and e-commerce sites that need database access and priority support.",
      whatYouGet: [
        "2 applications, each in its own managed container",
    ...
    seoContent: {
      whatIs:
        "Cloud VIP from Hawiyat is a managed cloud runtime in Algeria for up to two applications with a managed database included. At 2,000 DA/month, it is designed for full-stack apps, SaaS projects, and e-commerce sites that need database access and priority support. You get two applications, each running in its own managed container, a managed PostgreSQL or MySQL database, free SSL certificates, automatic deployments from Git, and 1GB RAM. Custom domain support with DNS management, automatic HTTPS through Let's Encrypt, advanced resource monitoring, and daily backups are all included. Priority support is available via WhatsApp. Whether you are launching a SaaS product, an e-commerce store, or a client project that needs a database, Cloud VIP gives you a professional-grade managed cloud runtime in Algeria, managed for you and billed in dinars.",
      whyChoose:
        "Cloud VIP from Hawiyat is a full-stack managed cloud runtime in Algeria with a managed database included. You get two applications, each in its own managed container, plus PostgreSQL or MySQL, managed entirely by our team, with daily backups and advanced monitoring. At 2,000 DA/month, you pay in Algerian dinars with CCP or Baridi Mob, no foreign credit card needed. Priority WhatsApp support comes in Arabic, French, and English. Your projects run on production-tested infrastructure that powers 100+ clients, with automatic HTTPS and custom domain management. Whether you are building a SaaS product, a client application, or an e-commerce site, Cloud VIP delivers a managed cloud runtime with database access, priority support, and local expertise.",
      howItWorks:
        "Getting your full-stack project live on Cloud VIP takes three steps. First, contact the team to order the plan at 2,000 DA/month using your preferred payment method: CCP, Baridi Mob, or USD. Second, connect your Git repositories: our platform builds up to two Node.js, Python, or static applications into managed containers, and our team provisions your managed PostgreSQL or MySQL database for you. Third, point your custom domains and get free SSL certificates from Let's Encrypt, so both apps are live on HTTPS within minutes. Each app keeps running in its managed container with 1GB RAM, advanced resource monitoring, and daily backups. Every deployment is automatic, push to Git and your changes go live. Priority support is available via WhatsApp whenever you need help. If you only need one app without a database, start with Cloud Basic at 1,000 DA/month and upgrade later.",
    },
    faq: [
      {
        question: "What is the difference between Cloud Basic and Cloud VIP?",
        answer:
          "Basic runs one application at 1,000 DA/month with 512MB RAM. VIP runs two applications plus a managed PostgreSQL or MySQL database at 2,000 DA/month, with 1GB RAM, daily backups, advanced monitoring, and priority WhatsApp support.",
      },
      {
        question: "Which databases are supported on Cloud VIP?",
        answer:
          "Cloud VIP includes a managed PostgreSQL or MySQL database, provisioned and maintained by our team. Daily backups and advanced resource monitoring are included.",
      },
      {
        question: "Can I run a SaaS or e-commerce site on Cloud VIP?",
        answer:
          "Yes. Cloud VIP is designed for full-stack apps, SaaS projects, and e-commerce sites that need database access, custom domains, automatic HTTPS, and priority support.",
      },
    ],
  },
]

      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <header className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-muted-ink">
            n8n automation, WhatsApp API, and app hosting, operated by the Hawiyat team and billed in dinars, with support in Arabic, French, and English. Run them on the execution layer for a full pipeline.
          </p>
        </header>

...
function Note({ children }: { children: ReactNode }) {
  return (
    <div className="mt-4 rounded-xl border border-border/60 bg-surface-dim/30 dark:bg-secondary/30 p-4 text-xs leading-relaxed">
      {children}
    </div>
  )
}
        ...
        <div className="mt-12 space-y-10 text-sm leading-relaxed text-muted-foreground">
            <section id="introduction" className="scroll-mt-24">
              ...
              <p className="mt-3">
                ...
                &quot;us,&quot; or &quot;our&quot;). This includes the Hawiyat Composer platform, associated APIs,
            ...
            <section id="definitions" className="scroll-mt-24">
              ...
              <ul className="mt-3 space-y-3">
                ...
                <li>
                  ...
                  Hawiyat&apos;s AI optimization layer. Composer sits between Users and Frontier Models. It optimizes
                  prompts, manages context windows, handles caching, selects which model to route a request to, and
                  post-processes Outputs before delivering them to you.
                </li>
                <li>
                  <span className="text-foreground font-medium">&quot;Optimization Layer.&quot;</span>{" "}
                  The software Hawiyat operates that sits between User Inputs and Frontier Models. It performs prompt
                  optimization, context management, routing across multiple model providers, output post-processing,
                  and caching.
                </li>
                <li>
                ...
                <li>
                  ...
                  The monthly usage allocation included in your subscription plan, measured in usage units as defined
                  on our pricing page.
                </li>
                <li>
                  <span className="text-foreground font-medium">&quot;Plan.&quot;</span>{" "}
                  The subscription tier you select (e.g., Starter, Growth, Scale, Team, Coding).
                </li>
                <li>
                ...
                <li>
                  <span className="text-foreground font-medium">&quot;Team/Coding Plans.&quot;</span>{" "}
                  Subscription plans for teams and development workflows that include a monthly usage quota.
                </li>
                <li>
            ...
            <section id="service" className="scroll-mt-24">
              <h2 className="text-lg font-medium text-foreground">5. The Service: Hawiyat Composer</h2>

              <h3 className="mt-4 font-medium text-foreground">5.1 What Composer Is</h3>
              <p className="mt-2">
                Hawiyat Composer is an AI optimization layer. It does not train, host, or operate the underlying AI
                models. Instead, it sits between you and Frontier Model providers, making your interactions with those
                models faster, cheaper, and more effective.
              </p>
              <p className="mt-2">
                The Optimization Layer optimizes your prompts before sending them to a model, routes requests to the
                best available model for the task, and post-processes raw model outputs before delivering them to you.
              </p>
              <p className="mt-2">
                Hawiyat owns and runs the Optimization Layer. The underlying AI models are owned and run by third-party
                providers (Anthropic, OpenAI, Google, and others). Your outputs are produced by those models, shaped by
                Hawiyat&apos;s optimization.
              </p>
              ...
              <ul className="mt-2 space-y-2">
                ...
                <li>
                  <span className="text-foreground font-medium">Input Optimization.</span>{" "}
                  When you submit Inputs, the Optimization Layer processes them before sending them to a Frontier
                  Model. This includes prompt engineering, context window management, token optimization, and request
                  structuring.
                </li>
                <li>
                  <span className="text-foreground font-medium">Model Routing.</span>{" "}
                  Composer picks the most appropriate Frontier Model based on the task type, complexity, cost, and
                  availability. This may include models from Anthropic, OpenAI, Google, and other providers.
                </li>
                <li>
                  <span className="text-foreground font-medium">Output Post-Processing.</span>{" "}
                  Raw outputs from Frontier Models pass through the Optimization Layer for formatting, validation,
                  safety checks, and quality review before you receive them.
                </li>
                <li>
                  <span className="text-foreground font-medium">Caching.</span>{" "}
                  The Optimization Layer caches frequent or similar requests to cut down on redundant model calls,
              ...
              <p className="mt-2">
                Hawiyat will use commercially reasonable efforts to keep the Optimization Layer available. The Service
              ...
              <p className="mt-2">
                Hawiyat provides customer support for all active subscribers. Support covers the Optimization Layer and
                Composer interface. Support for Frontier Model-specific behavior is limited to how that behavior
                appears through the Optimization Layer. Support is available in Arabic, French, and English through the
            ...
            <section id="payments" className="scroll-mt-24">
              ...
              <h3 className="mt-4 font-medium text-foreground">7.3 Subscription Plans</h3>
              <ul className="mt-2 space-y-2">
                <li>
                  <span className="text-foreground font-medium">API Plans.</span>{" "}
                  Billing: per-usage or subscription. Quota: as defined in plan. Payment: DZD via approved methods.
                </li>
                <li>
                  <span className="text-foreground font-medium">Team Plans.</span>{" "}
                  Billing: monthly subscription. Quota: monthly quota included. Payment: DZD via approved methods.
                </li>
                <li>
                  <span className="text-foreground font-medium">Coding Plans.</span>{" "}
                  Billing: monthly subscription. Quota: monthly quota included. Payment: DZD via approved methods.
                </li>
              </ul>
            ...
            <section id="quota" className="scroll-mt-24">
              <h2 className="text-lg font-medium text-foreground">8. Monthly Quota Policy</h2>
              <Note>
                <p>
                  This section applies to Team and Coding subscription plans. API-only plans may use different usage
                  models, as described at the time of purchase.
                </p>
              </Note>

              <h3 className="mt-4 font-medium text-foreground">8.1 Monthly Quota</h3>
              <p className="mt-2">
                Team and Coding plans include a monthly usage quota. This is your fixed usage ceiling for each billing
                cycle, the maximum you are entitled to under your plan for that month. The quota is measured in usage
                units as defined on our pricing page and varies by plan tier.
              </p>
              <p className="mt-2">
                Your monthly quota is your committed allocation. It covers your usage for the full month. The monthly
                limit stays as published on our pricing page and in your subscription dashboard until Hawiyat changes
                it. Any change to the monthly quota or pricing is communicated in advance through the dashboard, email,
                or other reasonable means, and takes effect in the next billing cycle.
              </p>

              <h3 className="mt-4 font-medium text-foreground">8.2 How Quota Works</h3>
              <ul className="mt-2 list-disc pl-5 space-y-1">
                <li>Your monthly quota is a fixed ceiling for the billing cycle. It does not expire early or reduce if unused;</li>
                <li>Usage is tracked against your quota throughout the month;</li>
                <li>You receive a notification at 80% utilization;</li>
                <li>
                  At 100%, additional usage beyond the monthly limit requires a separate arrangement under Section 8.3.
                </li>
              </ul>

              <h3 className="mt-4 font-medium text-foreground">8.3 Exceeding Your Monthly Quota</h3>
              <p className="mt-2">
                If your usage exceeds the monthly quota before the end of the billing cycle, or if you anticipate
                needing more than your plan provides, Hawiyat handles this through a charging process:
              </p>
              <ul className="mt-2 list-disc pl-5 space-y-1">
                <li>Contact Hawiyat support to request additional usage beyond your monthly quota;</li>
              ...
              <Note>
                ...
                <p className="mt-1">
                  Hawiyat will never automatically charge you for exceeding your monthly quota. If you hit your limit,
                  usage may be throttled or paused until you contact support and arrange additional quota. You control
                  what you pay beyond your plan.
                </p>
              </Note>

              <h3 className="mt-4 font-medium text-foreground">8.4 Quota Does Not Carry Over</h3>
              <p className="mt-2">
                Unused quota does not carry over to the next billing cycle. Each month&apos;s quota is independent.
                What you don&apos;t use this month does not add to next month.
              </p>

              <h3 className="mt-4 font-medium text-foreground">8.5 Changes to the Monthly Limit</h3>
              <p className="mt-2">
                Hawiyat may modify the monthly quota amounts in each plan tier, and the pricing for additional usage.
              ...
              <p className="mt-2">
                You can check your current quota usage, remaining allocation, and billing history through the Hawiyat
                dashboard. Usage data is provided on a best-effort basis; actual billing is based on Hawiyat&apos;s
                internal records.
              </p>
            </section>
            ...
            <section id="ip" className="scroll-mt-24">
              ...
              <p className="mt-2">
                Hawiyat and its licensors retain all rights, title, and interest in the Optimization Layer, including:
              </p>
              <ul className="mt-2 list-disc pl-5 space-y-1">
                <li>The Composer optimization pipeline, prompt engineering logic, and context management algorithms;</li>
                <li>Model routing and selection systems;</li>
                <li>Output post-processing and quality review systems;</li>
                <li>Caching architecture and performance optimization infrastructure;</li>
              ...
              <p className="mt-2">
                ...
                Optimization Layer is subject to each provider&apos;s terms of service.
              </p>
              ...
              <p className="mt-2">
                ...
                data usage policies. Where technically feasible, Hawiyat configures the Optimization Layer to route
            ...
            <section id="ai-limitations" className="scroll-mt-24">
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <span className="text-foreground font-medium">The Optimization Layer (Hawiyat):</span>{" "}
                  Software that optimizes prompts, routes requests, manages context, and post-processes outputs. It
                  improves the efficiency and quality of interactions with Frontier Models but does not generate the
                  underlying AI outputs.
                </li>
                <li>
                  ...
                  AI outputs based on optimized Inputs from the Optimization Layer.
                </li>
              </ul>
              <p className="mt-2">
                Output quality depends on both layers. Hawiyat controls the Optimization Layer but has no control over
                the Frontier Models.
              </p>

              <h3 className="mt-4 font-medium text-foreground">12.2 Limitations of Frontier Models</h3>
              <p className="mt-2">
                Outputs generated by Frontier Models, even after optimization by Composer, may:
              </p>
              <ul className="mt-2 list-disc pl-5 space-y-1">
              ...
              <h3 className="mt-4 font-medium text-foreground">12.3 Limitations of the Optimization Layer</h3>
              <p className="mt-2">Hawiyat&apos;s Optimization Layer:</p>
              <ul className="mt-2 list-disc pl-5 space-y-1">
                <li>May not optimize every request perfectly. Prompt optimization is heuristic and best-effort;</li>
                <li>May select a Frontier Model that is not ideal for a specific use case;</li>
                <li>May add latency or overhead through the optimization pipeline;</li>
                <li>
                  Cannot guarantee that caching, routing, or post-processing will improve every Output;
                </li>
              ...
              <p className="mt-2">
                ...
                code, content, or suggestions from the Service, whether produced by the Optimization Layer or the
              ...
              <p className="mt-2">
                ...
                restrictions even when accessing models through the Optimization Layer.
              </p>
            </section>
            ...
            <section id="third-party" className="scroll-mt-24">
              ...
              <p className="mt-2">
                ...
                between you and these providers through the Optimization Layer.
              </p>
              <p className="mt-2">
